...
dataset = datasets.MNIST(root=r'../../dataset', transform=transform, download=True)
dataloader = DataLoader(dataset, batch_size=BATCH_SIZE, shuffle=True)
disc = Discriminator(IMG_CHANNELS, FEATURE_DISC, NUM_CLASSES, IMAGE_SIZE).to(device)
gen = Generator(Z_DIM, IMG_CHANNELS, FEATURE_GEN, NUM_CLASSES, IMAGE_SIZE, GEN_EMBEDDING).to(device)
