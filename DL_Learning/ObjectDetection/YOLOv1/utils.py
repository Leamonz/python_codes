...
def non_max_suppression(bboxes, iou_threshold, prob_threshold, box_format='corners'):
    ...
    while bboxes:
        ...
        bboxes = [box for box in bboxes if
                  ...
                  intersection_over_union(torch.tensor([chosen_box[2:]]), torch.tensor([box[2:]]),
...
def mean_average_precision(pred_boxes, true_boxes, iou_threshold=0.5, box_format='corners', num_classes=20):
    ...
    for c in range(num_classes):
        ...
        # how many targets are there in an image
        # e.g. img0 - 3 bboxes
        # img1 - 5 bboxes
        ...
        for detection_idx, detection in enumerate(detections):
            ...
            if best_iou > iou_threshold:
                # check if this detection was computed before
        ...
        # beginning point (precision=1, recall=0)
