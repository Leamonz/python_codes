...
class VOCDataset(Dataset):
    def __init__(self, csv_files, image_dir, label_dir, split_size=7, num_boxes=2, num_classes=20, transform=None):
    ...
    def __getitem__(self, index):
        ...
        for box in boxes:
            ...
            # coordinates relative to each cell
            x_cell, y_cell = self.S * x - j, self.S * y - i
            # width & height relative ot each cell
